...
function Home({ locale }: { locale: Locale }) {
  const zh = locale === "zh";
  const skills = zh ? [{ label: "内容策略", detail: "把需求拆成清晰的内容框架", kind: "strategy" }, { label: "达人与平台运营", detail: "筛选、沟通与内容协同", kind: "operations" }, { label: "数据复盘", detail: "从表现中找到下一步", kind: "data" }, { label: "信息架构", detail: "把分散信息整理成系统", kind: "architecture" }, { label: "AI 工具与工作流", detail: "让重复工作更高效", kind: "ai" }, { label: "市场与竞品研究", detail: "从行业线索建立判断", kind: "research" }] : [{ label: "Content strategy", detail: "Turn a brief into a clear content framework", kind: "strategy" }, { label: "Creator & platform operations", detail: "Select, brief and coordinate creators", kind: "operations" }, { label: "Data review", detail: "Turn performance into a next step", kind: "data" }, { label: "Information architecture", detail: "Make scattered information usable", kind: "architecture" }, { label: "AI tools & workflows", detail: "Make repeated work more efficient", kind: "ai" }, { label: "Market & competitor research", detail: "Build judgement from industry signals", kind: "research" }];
